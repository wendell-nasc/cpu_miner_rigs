...
sudo rm -r /opt/xmrig/config.json && sudo nano /opt/xmrig/config.json

sudo nano /etc/systemd/system/start-xdag.sh
...
sudo systemctl daemon-reload && sudo systemctl stop xdag.service && sudo systemctl start xdag.service
sudo tail -f /var/log/start-xmrig-xdag.log 
sudo tail -f /var/log/start-deroluna-xdag.log
...
sudo touch /var/log/start-deroluna-xdag.log
sudo chown wendell:wendell /var/log/start-deroluna-xdag.log
sudo chmod 666 /var/log/start-deroluna-xdag.log
sudo touch /var/log/start-deroluna-xdag.log && sudo chown wendell:wendell /var/log/start-deroluna-xdag.log && sudo chmod 666 /var/log/start-deroluna-xdag.log
...
DEROLUNA_LOGFILE="/var/log/start-deroluna-xdag.log"
...
sudo systemctl daemon-reload && sudo systemctl enable xdag.service &&  sudo systemctl stop xdag.service && sudo systemctl restart xdag.service && sudo systemctl status xdag.service && sudo tail -f /var/log/start-deroluna-xdag.log
...
sudo chmod +x /etc/systemd/system/start-xdag.sh && sudo nano /etc/systemd/system/xdag.service
...
[Service]
ExecStart=/etc/systemd/system/start-xdag.sh
Restart=always
...
sudo systemctl disable mangonote.service && sudo systemctl stop mangonote.service && sudo systemctl daemon-reload && sudo systemctl enable xdag.service &&  sudo systemctl stop xdag.service && sudo systemctl restart xdag.service && sudo systemctl status xdag.service && sudo tail -f /var/log/start-deroluna-xdag.log
sudo systemctl daemon-reload && sudo systemctl enable xdag.service &&  sudo systemctl stop xdag.service && sudo systemctl restart xdag.service && sudo systemctl status xdag.service && sudo tail -f /var/log/start-deroluna-xdag.log


sudo nano /etc/systemd/system/start-xdag.sh
sudo systemctl daemon-reload && sudo systemctl enable xdag.service && sudo systemctl restart xdag.service && sudo systemctl status xdag.service && sudo tail -f /var/log/start-deroluna-xdag.log
sudo tail -f /var/log/start-deroluna-xdag.log
sudo tail -f /var/log/start-xmrig-xdag.log 
...
sudo journalctl -f -u xdag.service



sudo systemctl stop xdag.service
